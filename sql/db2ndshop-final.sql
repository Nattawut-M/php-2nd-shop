...
--
-- Host: localhost:8889
-- Generation Time: Nov 16, 2020 at 02:29 PM
...
-- Database: `2ndshop`
--
CREATE DATABASE IF NOT EXISTS `2ndshop` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `2ndshop`;
...
(16, 'Oneplus Nord', 'cpu: snapdragon series 7\r\nram: 6\r\nrom: 128', 19300, '8_aim__oneplus-nord.jpg', '2020-11-15 23:04:08', 8, 2),
(17, 'Forza 350', 'the new forza 350 2020', 190000, '1_khainui__forza350.jpg', '2020-11-15 23:08:29', 1, 1),
(18, 'Kawazaki ER6N', '2 สูบเรียง', 269000, '1_khainui__er6n.jpg', '2020-11-15 23:09:20', 1, 1),
(19, 'Honda CB650R', '4 สูบเรียง ABS', 289000, '1_khainui__cb650r.jpg', '2020-11-15 23:10:01', 1, 1);
...
DROP TABLE IF EXISTS `tb_type_product`;
...
--
ALTER TABLE `tb_product`
  MODIFY `pd_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
